...
public class Theme {
    ...
    public Theme(String id, String name, String background,
                 String textBackground, String textForeground, String textBorder,
    ...
    public static void Init() {
        ...
        for (String id : ThemeConfig.cfg.getYml().getConfigurationSection("theme").getKeys(false)) {
            ...
            Theme.themeHashMap.put(id, new Theme(id, name, background, textBackground, textForeground, textBorder, inputBackground, inputForeground, inputBorder));
        }
    }
    ...
    public static void changeTheme(String id) {
        ...
        themeHashMap.put(id, new Theme(id, name, background, textBackground, textForeground, textBorder, inputBackground, inputForeground, inputBorder));
    }
}
